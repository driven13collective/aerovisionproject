...
def index() -> rx.Component:
    return rx.center(
        rx.vstack(
            ...
            rx.divider(),
            rx.vstack(
                rx.heading("Beta Feedback", size="5"),
                rx.text_area(placeholder="Found a bug or have a feature idea?", width="100%"),
                rx.button("Submit to driven13collective", color_scheme="iris"),
                spacing="4",
                padding_top="2em",
                width="100%",
            ),
